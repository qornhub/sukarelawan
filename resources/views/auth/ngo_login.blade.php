    ...
    <div class="row min-vh-100">
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center p-3">
            <div class="form-section">
                ...
                <p class="text-muted">Sign in to your NGO account to continue managing your organization and activities</p>
                ...
                <form id="login-form" method="POST" action="{{ url('/login') }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <a href="{{ route('password.request', ['role' => 'ngo']) }}"  class="text-decoration-none"> Forgot password?</a>

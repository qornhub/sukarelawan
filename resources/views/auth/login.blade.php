    ...
    <div class="row min-vh-100">
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center p-3">
            <div class="form-section">
                ...
                <p class="text-muted">Sign in to your volunteer account to continue making a difference</p>
                ...
                <form id="login-form" method="POST" action="{{ route('login.volunteer.submit') }}">
                @csrf
...
@endif
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <a href="{{ route('password.request', ['role' => 'volunteer']) }}" class="text-decoration-none"> Forgot password?</a>
...
@elseif ($role === 'volunteer')
    <p class="login-link mt-4">Don't have an account? <a href="{{ url('/register/volunteer') }}">Sign up as Volunteer</a></p>
@elseif ($role === 'admin')
    <p class="login-link mt-4">Only Admins can be added manually.</p>
@endif
        ...
        <div class="col-lg-6 d-none d-lg-flex bg-right">
            <div class="bg-right-content">
                <p>Sign in to access your volunteer dashboard and manage your activities and impact.</p>
                <div class="mt-4">

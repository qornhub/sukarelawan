        ...
        <div class="row min-vh-100">
                    ...
                    <form id="signup-form" method="POST" action="{{ url('/register/ngo') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="organizationName" value="{{ old('organizationName') }}"
                                    class="form-control" placeholder="Enter your NGO name">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="registrationNumber" value="{{ old('registrationNumber') }}"
                                    class="form-control" placeholder="Enter your registration number">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon">
                                ...
                                <select name="country" class="form-select form-control">
                                    <option value="" disabled {{ old('country') ? '' : 'selected' }}>Select your
                                        country</option>
            ...
            <div class="col-lg-6 d-none d-lg-flex bg-right">
                <div class="bg-right-content">
                    ...
                    <p>Make a difference in your community by volunteering your time and skills. Help those in need and
                        be part of something meaningful.</p>
                    <div class="mt-4">

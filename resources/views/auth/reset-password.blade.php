    ...
    <input type="hidden" name="role" value="{{ request('role') }}">
            ...
            <div class="mb-4">
                ...
                <div class="input-icon password-container">
                    ...
                    <span class="password-toggle" id="toggle-new-password" style="position: absolute; right: 3rem; top: 50%; transform: translateY(-50%); cursor: pointer;">
                ...
                <div class="password-hints">
                    <div><i class="fas fa-circle" style="font-size: 6px; vertical-align: middle;"></i> Must be at least 8 characters</div>
                    <div><i class="fas fa-circle" style="font-size: 6px; vertical-align: middle;"></i> Should contain letters and numbers</div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-icon password-container">
                    ...
                    <input type="password" name="password_confirmation" id="confirm-password" class="form-control" placeholder="Confirm your password" required>
                     ...
                     <span class="password-toggle" id="toggle-confirm-password" style="position: absolute; right: 3rem; top: 50%; transform: translateY(-50%); cursor: pointer;">
                                <i class="fas fa-eye"></i>
                            </span>
                </div>
            ...
            if (confirmPasswordInput && passwordMatchDiv) {
                confirmPasswordInput.addEventListener('input', function() {
                    ...
                    if (password === confirmPassword) {
                        passwordMatchDiv.innerHTML = '<i class="fas fa-check-circle me-2"></i>Passwords match';
                        passwordMatchDiv.className = 'password-match status-success';
                    } else {
                        passwordMatchDiv.innerHTML = '<i class="fas fa-exclamation-circle me-2"></i>Passwords do not match';
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    if (!isValid) {
                        ...
                        errorBox.innerHTML = '<i class="fas fa-exclamation-circle me-2"></i>Please fix the errors in the form';

...
<div class="row g-3 mb-4">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="create-card h-100 text-center d-flex flex-column">
            ...
            <p class="small text-muted">Inspire change through meaningful actions that leave a lasting difference in the lives of others.</p>
            <a href="{{ route('ngo.events.create') }}" class="btn btn-primary btn-create mt-auto">Create Event</a>
        </div>
    </div>
</div>
                        ...
                        @forelse($topAttendanceEvents as $event)
                            <div class="attendance-item d-flex align-items-center mb-4 p-3 rounded">
                                <div class="event-image me-3">
                                    <img src="{{ $event['image'] }}" alt="Event Image" class="rounded">
                                </div>
                                <div class="event-details flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h6 class="event-title mb-0">{{ $event['title'] }}</h6>
                                        <span class="attendance-rate badge bg-primary">{{ $event['attendance_rate'] }}%</span>
                                    </div>

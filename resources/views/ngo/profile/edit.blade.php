        ...
        <div class="profile-card">
            <div class="profile-header">
                <img id="profilePhotoPreview"
                    src="{{ $profile->profilePhoto ? asset('images/profiles/' . $profile->profilePhoto) : asset('assets/default-profile.png') }}"
                ...
                <form action="{{ route('ngo.profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="organizationName"
                                    value="{{ old('organizationName', $profile->organizationName) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="registrationNumber"
                                    value="{{ old('registrationNumber', $profile->registrationNumber) }}"
                                    class="form-control" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="contactNumber"
                                    value="{{ old('contactNumber', $profile->contactNumber) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="url" name="website" value="{{ old('website', $profile->website) }}"
                                    class="form-control" placeholder="https://example.org">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="file" name="coverPhoto" class="form-control" accept="image/*"
                            onchange="previewImage(event, 'coverPhotoPreview')">
                        <div class="photo-preview-container mt-2">
                            <div class="preview-card">
                                @if ($profile->coverPhoto)
                                    <img id="coverPhotoPreview"
                                        src="{{ asset('images/covers/' . $profile->coverPhoto) }}"
                                        class="photo-preview" alt="Cover Preview">
                                @else
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-2">
                            @if ($profile->profilePhoto)
                                <img id="profilePhotoPreviewInline"
                                    src="{{ asset('images/profiles/' . $profile->profilePhoto) }}"
                                    class="photo-preview mt-2" alt="Profile Preview">
                            @else

    ...
    <div class="admin-container">
        <div class="page-header">
            <div class="header-top">
                ...
                <a href="{{ route('admin.blogcategory.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus me-2"></i>Add Blog Category
                </a>
            </div>
        </div>
        ...
        @if($categories->isEmpty())
            <div class="empty-state">
                ...
                <p class="text-muted">Get started by adding your first blog category.</p>
                <a href="{{ route('admin.blogcategory.create') }}" class="btn btn-primary mt-2">
                    ...
                    <div class="category-card">
                        <div class="category-content">
                            ...
                            <div class="category-actions">
                                <a href="{{ route('admin.blogcategory.edit', $category->blogCategory_id) }}" class="btn-action btn-edit">
                                    <i class="fas fa-edit me-1"></i> Edit
                                </a>
                                <form action="{{ route('admin.blogcategory.destroy', $category->blogCategory_id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this category?');">
                                    @csrf
                                    @method('DELETE')

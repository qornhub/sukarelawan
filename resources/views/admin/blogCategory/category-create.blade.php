    ...
    <div class="admin-container">
        <div class="page-header">
            <div class="header-top">
                ...
                <a href="{{ route('admin.blogcategory.category-list') }}" class="btn btn-secondary">
        ...
        <div class="form-section">
            <form action="{{ route('admin.blogcategory.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="categoryName" id="categoryName" class="form-control" value="{{ old('categoryName') }}" required>
                </div>

...
<head>
    <meta charset="UTF-8">
    <title>Create Badge Category</title>
...
<div class="admin-container">
    <div class="page-header">
        <div class="header-top">
            <h1 class="page-title">Create Badge Category</h1>
    ...
    <div class="form-section">
        <form action="{{ route('admin.badge_categories.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="badgeCategoryName" class="form-label">Category Name</label>
                <input type="text" name="badgeCategoryName" id="badgeCategoryName" class="form-control" required>
            </div>

{{-- resources/views/admin/badges/badge-edit.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="admin-container">
        <div class="page-header">
            <div class="header-top">
                <h1 class="page-title">Edit Badge</h1>
        ...
        <div class="form-section">
            <form action="{{ route('admin.badges.update', $badge->badge_id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="badgeName" class="form-control"
                               value="{{ old('badgeName', $badge->badgeName) }}" required>
                        @error('badgeName')
                        ...
                        <select name="badgeCategory_id" class="form-select" required>
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->badgeCategory_id }}"
                                    {{ old('badgeCategory_id', $badge->badgeCategory_id) == $category->badgeCategory_id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" name="pointsRequired" class="form-control"
                               value="{{ old('pointsRequired', $badge->pointsRequired) }}" min="1" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="badgeDescription" class="form-control" rows="3"
                              placeholder="Enter badge description...">{{ old('badgeDescription', $badge->badgeDescription) }}</textarea>
                ...
                <div class="form-group mb-3">
                    ...
                    @if(!empty($badge->badgeImage))
                        <img src="{{ asset($badge->badgeImage) }}" alt="Badge Image"
                             class="current-image">
                    @else
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" name="badgeImage" class="form-control" accept="image/*" onchange="previewImage(event)">
                    @error('badgeImage')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
                </div>

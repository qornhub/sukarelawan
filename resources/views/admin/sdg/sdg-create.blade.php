{{-- resources/views/admin/sdg/sdg-create.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Create SDG</title>
    ...
    <div class="admin-container">
        <div class="page-header">
            <div class="header-top">
                <h1 class="page-title">Add New Sustainable Development Goal</h1>
        ...
        <div class="form-section">
            <form action="{{ route('admin.sdg.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- SDG Name -->
                <div class="form-group">
                    <label class="form-label">SDG Name</label>
                    <input type="text" name="sdgName" class="form-control" value="{{ old('sdgName') }}" required>
                    @error('sdgName')
                ...
                <!-- SDG Image -->
                <div class="form-group">
                    <label class="form-label">SDG Image</label>
                    <input type="file" name="sdgImage" class="form-control" accept="image/*"
                ...
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save me-2"></i>Save SDG
                </button>
                <a href="{{ route('admin.sdg.sdg-list') }}" class="btn btn-secondary">
                    <i class="fas fa-times me-2"></i>Cancel
                </a>

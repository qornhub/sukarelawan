...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-success:hover {
            background: darken(var(--admin-success), 10%);
            transform: translateY(-1px);
    ...
    <div class="admin-container">
        <div class="page-header">
            <div class="header-top">
                ...
                <a href="{{ route('admin.skill.skill-list') }}" class="btn btn-secondary">
        ...
        <div class="form-section">
            <form action="{{ route('admin.skill.update', $skill->skill_id) }}" method="POST">
                @csrf
                @method('PUT')

...
<head>
    <meta charset="UTF-8">
    <title>Volunteer Profile | Admin View | SukaRelawan</title>
    ...
    {{-- Reuse volunteer profile CSS for same look --}}
    <link rel="stylesheet" href="{{ asset('css/volunteer_profile.css') }}">

    <style>
        /* Extra spacing to align with admin layout */
        .content-wrapper {
            margin-left: 70px;
            padding-bottom: 40px;
        }

        /* Make cards consistent with admin theme if needed */
        .card {
            border-radius: 12px;
...
<body>
    ...
    {{-- ADMIN NAV INSTEAD OF VOLUNTEER/NGO HEADER --}}
    ...
    <div class="content-wrapper">
            ...
            <div class="container pb-5" style="max-width: 1400px;">
                <div class="row g-4">
                            ...
                            <div class="card-body" style="padding: 1.25rem;">
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        <div>{{ $profile->gender ? ucfirst($profile->gender) : '-' }}</div>
                                    </div>
                                </div>
                                <div class="info-item">
                                    <div class="info-icon">
                                ...
                                <div class="info-item">
                                    ...
                                    <div>
                                        ...
                                        {{-- IMPORTANT: show volunteer's email, not admin's --}}
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <!-- Tabs Navigation -->
                            <ul class="nav nav-tabs admin-profile-tabs" id="profileTabs" role="tablist">
                            ...
                            <div class="tab-content mt-0" id="profileTabsContent">
                                ...
                                <div class="tab-pane fade {{ !request('past_page') && !request()->has('tab') ? 'show active' : '' }}"
                                    ...
                                    @forelse($upcomingEvents as $event)
                                        ...
                                        {{-- Admin view: show event as static card (not linked to volunteer edit/delete) --}}
                                ...
                                <div class="tab-pane fade {{ request()->has('tab') && request('tab') == 'blog' ? 'show active' : '' }}"
                                    ...
                                    @forelse($blogPosts as $post)
                                        @php
                                            ...
                                            // Admin follows public route
                                            $cardLink = $publicRoute;
                                        @endphp
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        ...
                                                        @if ($post->status !== 'published')
                                                            {{-- Admin still sees badge, but link is public route --}}
        ...
        </div> {{-- inner margin wrapper --}}
    </div> {{-- content-wrapper --}}

    {{-- No volunteer footer here to keep it admin-clean --}}
    {{-- @include('layouts.admin_footer') if you have one --}}

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    {{-- Optional: if volunteer profile JS is generic, you can still reuse it --}}

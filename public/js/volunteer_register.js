document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        const dob = form.querySelector('input[name="dateOfBirth"]').value;
        ...
        if (!name) {
            ...
            highlightError(form.querySelector('input[name="name"]'));
        ...
        if (!dob) {
            ...
            highlightError(form.querySelector('input[name="dateOfBirth"]'));
        } else {
            ...
            if (dobDate > minAgeDate) {
                errors.push('You must be at least 16 years old to volunteer');
                highlightError(form.querySelector('input[name="dateOfBirth"]'));
            }
        }
